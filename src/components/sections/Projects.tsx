            ...
            <div className=' flex flex-col lg:flex-row w-full h-full my-[100px] '>
                <div className=' w-full lg:w-[20%] '>
                    <div className=' w-full h-full flex flex-col lg:items-start items-center '>
                        <div className=' font-bold text-[26.34px] py-2 text-neutral-800 mb-3 lg:mb-0 '>Projects</div>
                        <div className=' flex flex-row lg:flex-col gap-3 '>
                            <div className=' border-b-2 lg:border-b-0 lg:border-s-2 border-[#2947A9] font-bold px-3 text-[17.56px] text-[#2947A9] '><button>All</button></div>
